...
- [Real-Time Audio Separation of Human Voices](real-time-audio-separation.md){:target="_blank"} — Real-time audio acquisition (Teensy + Raspberry Pi), I2S, UART, multithreaded processing, and ICA-based separation.
...
- [Resume & Cover Letter](resume-cover.md){:target="_blank"} — Tailored resume and a Shure-focused cover letter with contact links.
